...
public class AppBLL: BaseBLL<AppDbContext>, IAppBLL
{
    ...
    public ITripService TripService => _trips ?? new TripService(_uow, _uow.TripRepository, _mapper);
    ...
    public IExpenseService ExpenseService => _expenses ?? new ExpenseService(_uow, _uow.ExpenseRepository, _mapper);
